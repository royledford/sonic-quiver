...
const TestHtmlElements = () => {
  ...
  return (
    <div style={{    maxWidth: "800px", padding: "0 1rem", marginLeft: "auto", marginRight: "auto"}}>
			...
			<form>
				...
				<label htmlFor="checkbox1">
					<input id="checkbox1" name="checkbox" type="checkbox" defaultChecked /> Choice A</label>
				<label htmlFor="checkbox2">
					<input id="checkbox2" name="checkbox" type="checkbox" /> Choice B</label>
				<label htmlFor="radio1">
					<input id="radio1" name="radio" type="radio" hecked="checked" /> Option 1</label>
...
export default TestHtmlElements